...
import br.com.mvc.bo.CategoryBO;
...
public class ServletCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher(Category.insert(request.getParameter("categoryName"), request.getParameter("itemName"))).forward(request, response);
	}
